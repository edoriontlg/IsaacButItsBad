...
public class Shop extends Room{
    ...
    public Shop(Hero hero){
        ...
        ObjectPickable.add(new ObjectOnGround(new Vector2(0.45, 0.7), new Vector2(0.08,0.08),"Cain.png"));
        ...
        ObjectPickable.add(new ObjectOnGround(new Vector2(0.25, 0.55),new Vector2(0.03,0.03),ImagePaths.DIX));
        ObjectPickable.add(new ObjectOnGround(new Vector2(0.55, 0.55),new Vector2(0.03,0.03),ImagePaths.DIX));
